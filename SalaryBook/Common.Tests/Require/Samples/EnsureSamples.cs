...
namespace Pellared.Common.Contracts.Tests.Tests.Samples
{
    [TestClass]
    public class EnsureSamples
    {
        ...
        public void Sample(string argument)
        {
            ...
            Ensure.That(argument, "argument").WithExtraMessageOf(() => "argument caused a memory leak").IsNotNullOrWhiteSpace();
        }
