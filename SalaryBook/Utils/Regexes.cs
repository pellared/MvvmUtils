...
namespace Pellared.Utils
{
    public static class Regexes
    {
        ...
        public static Regex UserName { get { return new Regex(UserNameRegex); } }

        public const string UrlRegex = @"^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?}$";
        public static Regex Url { get { return new Regex(UrlRegex); } }

        public const string IpRegex = @"^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$";
        public static Regex Ip { get { return new Regex(IpRegex); } }
    }
}